                            ...
                            <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                <tr>
                                    <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                                        <h2>You have failed to report in</h2>
                                        <br>
                                        {{$data['name']}},
                                        <br><br>
                                        <strong>If you have filed for Leave of Absence and it was approved, you can disregard this message.</strong>
                                        <br><br>
                                        You are receiving this message as you have failed to report in. Due to this, Catalyst has automatically created an infraction report for this incident.
                                        <br><br>
                                        If you no longer want to be a part of the 1st RRF and unsubscribe from our messages, you can request a formal discharge via this link: <a href="https://1st-rrf.com/forms/create/discharge">Discharge Form.</a>
                                        <br><br>
