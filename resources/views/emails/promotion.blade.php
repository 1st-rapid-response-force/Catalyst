                            ...
                            <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                <tr>
                                    <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                                        ...
                                        <h1>You have been promoted</h1>
                                        {{$data['name']}},<br><br>
                                        I would like to be the first to inform you of your promotion from {{$data['promotion_old']}} to {{$data['promotion_new']}}
                                        <br><br>
                                        Congratulation! Catalyst has already updated your teamspeak, squadxml, and the website roster.
                                        <br><br>
                                        The only thing you need to do is make sure to update your in-game name in ARMA 3 to <strong>{{$data['name']}}</strong>.
                                        <br>
                                        <p>CPT. Rodriguez.G<br />Unit Commander<br >1st Rapid Response Force<br/><img src="http://i.imgur.com/AJkw50f.png"/></p>
                                        <br><br><br>
