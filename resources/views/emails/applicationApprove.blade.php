                            ...
                            <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                <tr>
                                    <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                                        ...
                                        <ol>
                                            <li>Add your Teamspeak ID to your Virtual Personnel File to obtain your rank and permissions on Teamspeak - <a href="http://1st-rrf.com/virtual-personnel-file/teamspeak">Manage your Teamspeak IDs</a></li>
                                            <li>Edit your Face for your CAC Card - <a href="http://1st-rrf.com/virtual-personnel-file/faces">Edit My Face</a></li>
                                            <li>Download your CAC Card and set it up as your Teamspeak Avatar - <a href="http://1st-rrf.com/cac/{{$data['steam_id']}}">CAC Card</a></li>
