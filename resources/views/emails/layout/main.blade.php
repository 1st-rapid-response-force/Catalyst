...
<head>
    ...
    <title>1st Rapid Response Force</title>
        ...
        <td class="navbar navbar-inverse" align="center">
            ...
            <table width="650px" cellspacing="0" cellpadding="3" class="container">
                <tr class="navbar navbar-inverse">
                    <td colspan="4"><a class="brand" href="{{url()}}">1st RRF</a></td>
                    <td><ul class="nav pull-right"><li><a href="{{url().'/login'}}">Log On</a></li></ul></td>
                </tr>
            </table>
        </td>
    </tr>
