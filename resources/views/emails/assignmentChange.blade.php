                            ...
                            <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                <tr>
                                    <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                                        ...
                                        <h1>Your Assignment Change Request</h1>
                                        <br>
                                        Your assignment change request has been processed. Your request to be assigned to position {{$data['requested_assignment']}} has been: {{$data['approved']}}.
                                        <br><br>
