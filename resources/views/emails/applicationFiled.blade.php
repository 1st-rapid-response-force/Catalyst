                            ...
                            <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                <tr>
                                    <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                                        ...
                                        <h1>Enlistment Paperwork Filed!</h1>
                                        <br>
                                        You have successfully filed your enlistment paperwork. You will be notified via email our decision or you can check the website.
                                        <br><br>
                                        <a href="http://1st-rrf.com/enlistment/my-application">My Application (this will be updated based on our decision) </a>
                                        <br>
                                        <br>
