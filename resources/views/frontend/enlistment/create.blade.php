...
@section('content')
    ...
    <form class="grid-form">
        {!! csrf_field() !!}
        <div class="text-center"><legend><strong>ENLISTMENT/REENLISTMENT DOCUMENT</strong><br> 1ST RAPID RESPONSE FORCE</legend></div>
        ...
        <fieldset>
            ...
            <div data-row-span="1">
                <div data-field-span="1">
                    <label>BILLET SELECTION</label>
                    <label><input type="checkbox" disabled> SPECIAL OPERATIONS</label> &nbsp;
                    <label><input type="checkbox"> SPECIAL OPERATIONS - RECON</label> &nbsp;
                    <label><input type="checkbox"> MECHANISED INFANTRY</label> &nbsp;
                    <label><input type="checkbox"> MOTORISED INFANTRY</label> &nbsp;
                    <label><input type="checkbox"> AIRBORNE INFANTRY</label> &nbsp;
                    <label><input type="checkbox"> AIR ASSAULT</label>
                    <label><input type="checkbox"> ROTARY CAS</label>
                    <label><input type="checkbox"> FIXED WING/AIR SUPREMACY</label>
                    <label><input type="checkbox"> ARTILLERY</label>
                    <label><input type="checkbox"> AMPHIBIOUS</label>
                    <label><input type="checkbox"> LOGISTICS</label>
                </div>
            </div>
            <BR>
            <fieldset>
            ...
            <fieldset>
                ...
                <div data-row-span="2">
                    <div data-field-span="1">
                        ...
                        <label><input type="radio" name="agreement.milsim" value="1"> YES</label> &nbsp;
                        <label><input type="radio" name="agreement.milsim" value="0" checked> NO</label> &nbsp;
                    </div>
                    <div data-field-span="1">
                        ...
                        <label><input type="radio" name="agreement.guidelines" value="1"> YES</label> &nbsp;
                        <label><input type="radio" name="agreement.guidelines" value="0" checked> NO</label> &nbsp;
                    </div>
                </div>
                <div data-row-span="2">
                    <div data-field-span="1">
                        <label>I UNDERSTAND THAT I AM EXPECTED TO FOLLOW ORDERS GIVEN TO ME</label>
                        <label><input type="radio" name="agreement.orders" value="1"> YES</label> &nbsp;
                        <label><input type="radio" name="agreement.orders" value="0" checked> NO</label> &nbsp;
                    </div>
                    <div data-field-span="1">
                        <label>I UNDERSTAND THAT I AM EXPECTED TO RESPECT RANKS, CUSTOMS AND COURTESIES</label>
                        <label><input type="radio" name="agreement.ranks" value="1"> YES</label> &nbsp;
                        <label><input type="radio" name="agreement.ranks" value="0" checked> NO</label> &nbsp;
                    </div>
                </div>
            </fieldset>
            <br>
