...
@section('breadcrumbs')
    <li><a href="/admin/"><i class="fa fa-dashboard"></i> Dashboard</a></li>s
    <li><a href="{{ route('admin.enlistments.index')}}"><i class="fa fa-file"></i> Enlistment Manager</a></li>
    <li class="active"><i class="fa fa-users"></i> View Enlistment Application</li>
@endsection

@section('content')
    <a href="{{route('admin.enlistments.edit',$app->id)}}" class="btn btn-primary">Edit User</a>
