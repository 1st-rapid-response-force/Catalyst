...
<li class="active">VPF Correction Request - {{$vpf_cr->VPF}}</li>
@endsection
                ...
                <div class="panel-body">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly type="text" value="{{$vpf_cr->name}}" class="form-control">
                            <a href="{{route('admin.vpf.show',$vpf_cr->VPF->id)}}" target="_blank">View Virtual Personal File</a>
                        </div>
                        <div class="form-group">
                            <label>Correction Summary:</label>
                            <textarea readonly class="form-control">{{$vpf_cr->correction_summary}}</textarea>
                        </div>
                        <div class="form-group">
